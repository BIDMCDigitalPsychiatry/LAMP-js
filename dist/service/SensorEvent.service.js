            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Fetch_1.Fetch.get("/participant/" + participantId + "/sensor_event?" + queryParameters.toString())];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Fetch_1.Fetch.get("/researcher/" + researcherId + "/sensor_event?" + queryParameters.toString())];
                    case 1: return [2 /*return*/, (_b = (_a = (_c.sent())) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.map(function (x) { return Object.assign(new SensorEvent_1.SensorEvent(), x); })];
                }
            });
        });
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Fetch_1.Fetch.get("/study/" + studyId + "/sensor_event?" + queryParameters.toString())];
                    case 1: return [2 /*return*/, (_b = (_a = (_c.sent())) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.map(function (x) { return Object.assign(new SensorEvent_1.SensorEvent(), x); })];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Fetch_1.Fetch.post("/participant/" + participantId + "/sensor_event", sensorEvent)];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Fetch_1.Fetch.delete("/participant/" + participantId + "/sensor_event?" + queryParameters.toString())];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
